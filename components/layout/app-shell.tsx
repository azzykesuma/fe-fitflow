      ...
      <header className="sticky top-3.5 z-20 mb-6 rounded-2xl border border-t-lime-500/15 border-b-white/3 border-x-white/4 bg-[#050b08]/80 px-4 py-2.5 shadow-[0_16px_40px_-8px_rgba(0,0,0,0.6)] backdrop-blur-md">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/settings"
              className="flex size-9 items-center justify-center rounded-xl border border-white/8 bg-white/4 text-slate-400 hover:bg-white/8 hover:text-white transition duration-200 cursor-pointer shadow-sm"
              title="Settings"
            >
